...
enum TestData {
    ...
    static func subscribeToAll(observationContainer: inout [TypedNotificationObservation], notificationCenter: TypedNotificationCenter) {
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification1.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification2.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification3.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification4.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification5.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification6.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification7.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification8.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification9.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification10.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification11.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification12.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification13.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification14.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification15.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification16.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification17.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification18.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification19.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification20.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification21.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification22.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification23.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification24.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification25.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification26.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification27.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification28.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification29.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification30.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification31.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification32.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification33.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification34.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification35.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification36.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification37.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification38.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification39.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification40.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification41.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification42.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification43.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification44.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification45.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification46.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification47.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification48.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification49.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification50.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification51.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification52.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification53.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification54.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification55.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification56.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification57.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification58.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification59.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification60.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification61.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification62.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification63.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification64.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification65.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification66.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification67.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification68.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification69.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification70.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification71.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification72.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification73.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification74.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification75.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification76.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification77.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification78.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification79.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification80.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification81.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification82.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification83.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification84.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification85.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification86.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification87.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification88.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification89.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification90.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification91.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification92.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification93.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification94.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification95.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification96.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification97.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification98.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification99.self, object: nil) { _, _ in })
        observationContainer.append(notificationCenter.observe(PerformanceTestNotification100.self, object: nil) { _, _ in })
    }
